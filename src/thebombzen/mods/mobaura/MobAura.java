...
@Mod(modid = "mobaura", name = "MobAura", version = "2.7.1", dependencies = "required-after:thebombzenapi", guiFactory = "thebombzen.mods.mobaura.ConfigGuiFactory")
public class MobAura extends ThebombzenAPIBaseMod {
	...
	public String getLongVersionString() {
		return "MobAura, version 2.7.1, Minecraft 1.7.2";
	}
